...
if st.session_state.projectbestand is None:
    ...
    if st.session_state.doelstelling == 'Circulair':
        ...
        max_circulair = [data.iloc[1, 2] * data.iloc[i, 5] for i in range(len(lp_variabelen))]
        st.markdown(f"max C: {max_circulair}")
        min_circulair = [data.iloc[1, 1] * data.iloc[i, 5] for i in range(len(lp_variabelen))]
        ...
        max_budget = [data.iloc[1, 2] * data.iloc[i, 4] for i in range(len(lp_variabelen))]
        st.markdown(f"max B: {max_budget}")
        min_budget = [data.iloc[1, 1] * data.iloc[i, 4] for i in range(len(lp_variabelen))]
    ...
    if st.session_state.doelstelling == 'Budget':
        ...
        prob +=  1/3 * circulair + 2/3 * budget + afwijkingen
