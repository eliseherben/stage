...
with tab1:
    ...
    if uploaded_file is not None:
        ...
        dataframe.rename(columns={dataframe.columns[13]: "impact onderhoud"}, inplace=True)
        dataframe.rename(columns={dataframe.columns[14]: "impact circulair"}, inplace=True)
        dataframe.rename(columns={dataframe.columns[15]: "impact kwaliteit"}, inplace=True)
        dataframe.rename(columns={dataframe.columns[16]: "impact budget"}, inplace=True)
        dataframe.rename(columns={dataframe.columns[17]: "impact woonbeleving"}, inplace=True)
